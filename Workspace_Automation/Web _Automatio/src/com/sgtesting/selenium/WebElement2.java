	...
	public static WebDriver oBrowser=null;
		...
		static void Login()
		{
			try
			{
				...
				WebElement login2=oBrowser.findElement(By.name("pwd"));
				login2.sendKeys("manager");
				WebElement login3=oBrowser.findElement(By.xpath("//*[@id='loginButton']/div"));
				login2.click();
				Thread.sleep(4000);
			}catch(Exception e)
			{
		...
		static void ModifyUser()
		{
			try
			{
				WebElement modify=oBrowser.findElement(By.xpath("//*[@id=\'userListTableContainer\']/table/tbody/tr[2]/td[3]/span"));
				modify.click();
				Thread.sleep(4000);
			}catch(Exception e)
			{
